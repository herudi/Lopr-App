...
@NamedQueries({
    ...
    @NamedQuery(name = "Problem.findByUid", query = "SELECT p FROM Problem p WHERE p.uid = :uid"),
...
public class Problem implements Serializable {
    ...
    public Problem(Integer id, String uid) {
        this.id = id;
        this.uid = uid;
    }
    ...
    public String toString() {
        return "com.herudi.model.Problem[ id=" + id + " ]";
    }
